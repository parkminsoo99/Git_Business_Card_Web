...
function MyCard({user_profile_info}) {
    ...
    if (status === 'authenticated') { //로그인 된 경우 Login 버튼 없애기
        return (
            <> < Header /> <section className="text-gray-600 body-font mb-24">
                <div
                    ...
                    <div onClick={onClick} className="card rounded-md w-96 h-60 bg-black">
                        <div className="front">
                            ...
                            <div className="followers_num">👨‍👦‍👦{user_profile_info.followers}</div>
                            <div className="followers">followers</div>
                            <div className="following_num">{user_profile_info.following}</div>
                            <div className="following">following</div>
                            <div className="organization">🏙 {user_profile_info.company}</div>
                        ...
                        <div className="back">
                            <div className="flex flex-col items-center justify-center h-full">
                                <img
                                    src={`https://github-readme-stats.vercel.app/api?username=${user_profile_info.login}&show_icons=true&theme=monokai`}
                                    className="w-96 h-40"/>
                                <img
                                    src={`https://github-readme-stats.vercel.app/api/top-langs/?username=${user_profile_info.login}&layout=compact`}
                                    className="w-96 h-20"/>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <Modal onClose={() => setShowModal(false)} show={showModal}>
                                    <section className="text-gray-600 body-font">
                                        <div
                                            className="container mx-auto flex px-5  justify-center items-center">
                                            <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
                                                <div className="flex w-full justify-center items-end">
                                                    ...
                                                    <button
                                                        onClick={handleCopy1} className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-12">
                                                        <pre>복사</pre>
                                                    </button>
                                                </div>
                                            </div>
...
export async function getServerSideProps(context) {
    ...
    if (session?.accessToken) {
        ...
        const user_profile_info = await response.json();
        return {
